...
public class TC002_Login_Prepaid_Test extends Setup_Methods {
    ...
    public static void login_Test() throws IOException, InterruptedException {
        ...
        for (int i = 1; i < 2; i++) {
            ...
            Thread.sleep(4000);
            String name = "Online Ordering";
            WebElement onlineOrderingButton = driver.findElement(By.xpath("//*[@id=\"nav-order\"]"));
            String online = onlineOrderingButton.getText();
            prln("Homepage loading test complete\n=======");
            Assert.assertEquals(online, name);
