...
public class MYQC_5_Rewards_Page extends Setup_Methods {

    ExtentTest logger;

    public MYQC_5_Rewards_Page(WebDriver driver) {
        super();
    ...
    public MYQC_5_Rewards_Page clickOnDonateButton() throws IOException, InterruptedException {
        All_Reusable_Methods.click(driver, donateButton, 0, logger, "Donation Button");
        return new MYQC_5_Rewards_Page(driver);
    }

    public MYQC_5_Rewards_Page clickOnHome() throws IOException, InterruptedException {
    ...
    public Boolean presenseofDonationButton() throws IOException, InterruptedException {
        return All_Reusable_Methods.elementPresent(driver, donateButton, 0, logger, "Donation Button");
